...
get dd2/variables = !y !x SDS_scale/MISSING = OMIT.
...
do if (jjj > !iterate).
  ...
  do if (#d = 1).
    ...
    print/title = "Also see Chapter 5 of Introduction to Mediation, Moderation, and "+
    "Conditional"/space=0.
    print/title = "Analysis.  New York: The Guilford Press.  "+
    "http://www.guilford.com/p/hayes3"/space=0. 
    print/title = "*****************************************************************"/space=0.
...
RESTORE.
!ENDDEFINE.
INDIRECT y = MHI_scale/x = Intervention/m = SDS_scale /boot = 5000/conf = 95/normal = 1/contrast = 
    0/percent = 0/bc = 1/bca = 0.
